...
function toggleMapColors() {
  ...
  var mapHighlight1 = Array.from(
    document.getElementsByClassName('map__highlight--1')
  )
  var mapHighlight2 = Array.from(
    document.getElementsByClassName('map__highlight--2')
  )
  var mapHighlight3 = Array.from(
    document.getElementsByClassName('map__highlight--3')
  )
  var mapHighlight4 = Array.from(
    document.getElementsByClassName('map__highlight--4')
  )
  var mapHighlight5 = Array.from(
    document.getElementsByClassName('map__highlight--5')
  )
